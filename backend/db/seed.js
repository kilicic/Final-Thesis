...
const sql_create_emotion_id_index = `CREATE INDEX idx_emotion ON emotion(imageId, sex)`;
...
const sql_insert_emotion = `INSERT INTO emotion (
    ...
    surpriseSD, disgustM, disgustSD, angerM, angerSD, valenceM, valenceSD, arousalM, arousalSD)
    VALUES 
